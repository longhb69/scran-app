    ...
    return (
        ...
        >
            <div className="absolute top-0 bottom-0 right-0 left-0 transition">
                <div className={`${collapse ? "hidden" : ""} overflow-hidden flex flex-col items-center min-h-full h-full overflow-auto backdrop-blur-[6px]`}>
                    ...
                    <Link  to="/dsA1" className="mr-[4px] w-full hover:bg-[#111111]/[.1] ml-[8px] cursor-pointer text-left justify-center">
                        <div className="p-2 text-base text-white">
                            <span className="w-full h-full">Danh sách Thi A1</span>
                        </div>
                    </Link>
